		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					 if ($("#newstypeId").val()==""){
                        $("#newstypeName").focus();
                        top.$.jBox.tip('请选择栏目','warning');
                    }else if (CKEDITOR.instances.newsdetailcontent.getData()=="" ){
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxsys}/news/newsdetail/list?newstypeid.newstypeid=${newsdetail.newstypeid.newstypeid}">站内资讯内容列表</a></li>
		<li class="active"><a href="#">站内资讯内容${not empty newsdetail.newsdetailid?'修改':'添加'}</a></li>
	</ul><br/>
	
	<form:form id="inputForm" modelAttribute="newsdetail" action="${ctxsys}/news/newsdetail/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<tags:treeselect id="newstype" name="newstypeid.newstypeid" value="${newsdetail.newstypeid.newstypeid}" labelName="newstypeid.newstypename" labelValue="${newsdetail.newstypeid.newstypename}"
					title="栏目" url="${ctxsys}/news/newstype/treeData" extId="" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<tags:treeselect id="tallytag" name="tallytag" value="${newsdetail.tallytag}" labelName="tallyTagList" labelValue="${newsdetail.tallytag}" 
				title="标签"   url="${ctxsys}/news/newstype/treetallly" extId="" allowClear="true" checked="true" />
				<label id="nonull" style="display: none;" class="error">标签</label>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="tallyone.newstypeid">标签1:</label>
			<div class="controls">
				<tags:treeselect id="tallyones" name="tallyones.newstypeid" value="${newsdetail.tallyones.newstypeid}" labelName="tallyones.newstypename" labelValue="${newsdetail.tallyones.newstypename}"
					title="标签1:" url="${ctxsys}/news/newstype/treeData" extId="" />
			</div>
			<label class="control-label" for="tallytwo.newstypeid">标签2:</label>
			<div class="controls">
				<tags:treeselect id="tallytwos" name="tallytwos.newstypeid" value="${newsdetail.tallytwos.newstypeid}" labelName="tallytwos.newstypename" labelValue="${newsdetail.tallytwos.newstypename}"
					title="标签2:" url="${ctxsys}/news/newstype/treeData" extId=""/>
			</div>
			<label class="control-label" for="tallythree.newstypeid">标签3:</label>
			<div class="controls">
				<tags:treeselect id="tallythrees" name="tallythrees.newstypeid" value="${newsdetail.tallythrees.newstypeid}" labelName="tallythrees.newstypename" labelValue="${newsdetail.tallythrees.newstypename}"
					title="标签3:" url="${ctxsys}/news/newstype/treeData" extId="" />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="djIoscnt">点击次数（IOS）:</label>
			<div class="controls">
				<form:input path="djIoscnt" htmlEscape="false" maxlength="50"  readonly="true"/>
			</div>
		</div>
