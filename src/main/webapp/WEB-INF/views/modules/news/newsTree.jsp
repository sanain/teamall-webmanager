	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            ...
		            {id:'${newstype.newstypeid}', pId:'${not empty newstype.parent?newstype.parent.newstypeid:0}', name:"${newstype.newstypename}", url:"${ctxsys}/news/newsdetail/list?newstypeid.newstypeid=${newstype.newstypeid}", target:"newsMainFrame"},
		            </c:forEach>];
