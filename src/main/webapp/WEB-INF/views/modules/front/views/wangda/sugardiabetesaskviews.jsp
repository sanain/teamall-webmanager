			...
			<div class="center">
				<div class="l">
					<div class="Gnavbar" style="">
						<ul style="">
							<li><a href="${ctx}/userinfo/chronicillness/SugarDiabetesAskInfo"
								class="opacity  on ">糖尿病</a></li>
							<li><a href="${ctx}/userinfo/chronicillness/HypertensionAskInfo" class="opacity">高血压</a>
							</li>
						</ul>
				...
				<div class="r">
					...
					<form id="searchForm" action="${ctx}/userinfo/chronicillness/SugarDiabetesAskInfo" name="searchForm" class="form-inline">
					...
					<div class="Gselect on">
						<table cellspacing="0" cellpadding="0">
							<tr class="tr1">
								...
								<td align="center">随访时间</td>
								<td align="center">医院</td>
								<td align="center">随访类型</td>
								<td align="center">操作</td>
							</tr>
							<c:forEach items="${page.list}" var="sugardiabetes"  varStatus="i">
								
								<tr class="tr1">
									<td align="center">${i.index+1}</td>
									<td align="center">${sugardiabetes.followTime}</td>
									<td align="center">${sugardiabetes.followOrgName}</td>
									<td align="center">糖尿病</td>
									<td align="center"><a href="" id="${sugardiabetes.id}"
										class="chakan">查看</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
...
$("a.chakan").on("click",function(){ 
	layer.open({ 
			  type: 2,
			    ...
			    shade: 0.8,
			    area : [ '900px', '600px' ],
			    content : '${ctx}/userinfo/chronicillness/SugarDiabetesAskDetailInfo?idrecord='+$(this).attr("id")
