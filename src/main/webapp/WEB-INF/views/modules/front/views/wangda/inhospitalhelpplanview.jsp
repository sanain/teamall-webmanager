			...
			<div class="center">
				<div class="l">
					<div class="Gnavbar" style="">
						<ul style="">
						<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalBaseInfo?idnote=${zhiliaojihuainfo.idNote}&idextension=${zhiliaojihuainfo.idExtension}" class="opacity ">住院信息</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalSymptomInfo?idnote=${zhiliaojihuainfo.idNote}&idextension=${zhiliaojihuainfo.idExtension}" class="opacity ">症状</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalReportInfo?idnote=${zhiliaojihuainfo.idNote}&idextension=${zhiliaojihuainfo.idExtension}" class="opacity">检查检验报告</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalDiagnoseInfo?idnote=${zhiliaojihuainfo.idNote}&idextension=${zhiliaojihuainfo.idExtension}" class="opacity">诊断记录</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalHelpPlanInfo?idnote=${zhiliaojihuainfo.idNote}&idextension=${zhiliaojihuainfo.idExtension}" class="opacity on ">治疗计划</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalDrugInfo?idnote=${zhiliaojihuainfo.idNote}&idextension=${zhiliaojihuainfo.idExtension}" class="opacity">用药</a>
							</li>
						</ul>
					...
					<div class="Gselect on">
						<table cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="75%" class="indent">${zhiliaojihuainfo.disposalPlan}</td>
							</tr>
							<tr>
								<td width="25%" align="center">处置计划描述</td>
								<td width="75%" class="indent">${zhiliaojihuainfo.disposalPlanDescription}</td>
							</tr>
							<tr>
								<td width="25%" align="center">治疗方案</td>
								<td width="75%" class="indent">${zhiliaojihuainfo.treatmentPlan}</td>
							</tr>
							<tr>
								<td width="25%" align="center">治疗方案描述</td>
								<td width="75%" class="indent">${zhiliaojihuainfo.treatmentPlanDescription}</td>
							</tr>
