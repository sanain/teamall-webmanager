...
<div id="content" class="Mee"> 
			...
			<div class="bar">
					<ul>
							...
							<li><a href="${ctx}/userinfo/orderinfo?id=1" class="opacity on">已付款</a></li>
							<li><a href="${ctx}/userinfo/orderinfo?id=2" class="opacity">退订或过期</a></li>
							<li><a href="${ctx}/userinfo/orderinfo?id=3" class="opacity">已完成</a></li>
			...
			<div class="met">
					    ...
					    <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
					     <input id="" name="id" type="hidden" value="1"/>
		 		        </form>	
						<div class="center"> 
									...
									<!-- 	<td width="260px">医院名称</td>
										...
										<c:forEach items="${page.list}" var="order" varStatus="i">
											...
											<%-- <a href="${ctx}/userinfo/cancelform?id=${order.poid}" onclick="return confirmx('确认要退号吗？', this.href)">退号</a> --%> 
											</td>
											</tr>
										</c:forEach> 
