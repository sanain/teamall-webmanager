			...
			<div class="center">
				<div class="l">
					<div class="Gnavbar" style="">
						<ul style="">
							<li><a href="${ctx}/userinfo/aduitMedical/aduitMedicalInfo" class="opacity">成人体检记录</a>
							</li>
							<li><a href="${ctx}/userinfo/antenatal/antenatalInfo"  class="opacity">产检记录</a>
							</li>
							<li><a href="${ctx}/userinfo/erTongJianKangTiJianDan/erTongJianKangTiJianDanInfo"  class="opacity on ">儿童体检记录</a>
							</li>
							<li><a href="${ctx}/userinfo/yuFangJieZhong/yuFangJieZhongInfo">预防疫苗记录</a>
							</li>
						</ul>
				...
				<div class="r">
					...
					<div class="Gselect on">
						<table cellspacing="0" cellpadding="0">
							<tr class="tr1">
								<td  align="center">体检日期</td>
								<td  align="center">体检医院</td>
								<td align="center">体检人</td>
								<td  align="center">操作</td>
							</tr>
						<c:forEach items="${page.list }" var="aduitMedical" varStatus="varStatus" >	
						<tr class="tr1">	
								<td align="center">${aduitMedical.visitDay }</td>
								<td align="center">${aduitMedical.hospitalName }</td>
									<td align="center">${aduitMedical.childName }</td>
...
$("a.chakan").on("click",function(){ 
	layer.open({ 
			  type: 2,
			    ...
			    shade: 0.8,
			    area : [ '900px', '600px' ],
			    content : '${ctx}/userinfo/erTongJianKangTiJianDan/erTongJianKangTiJianDanDetail?id='+$(this).attr("id")
