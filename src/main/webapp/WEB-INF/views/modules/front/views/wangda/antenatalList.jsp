			...
			<div class="center">
				<div class="l">
					<div class="Gnavbar" style="">
						<ul style="">
							...
							<li><a href="${ctx}/userinfo/antenatal/antenatalInfo" class="opacity on ">产检记录</a>
							</li>
							<li><a href="${ctx}/userinfo/erTongJianKangTiJianDan/erTongJianKangTiJianDanInfo" class="opacity">儿童体检记录</a>
							</li>
				...
				<div class="r">
					...
					<div class="Gselect on">
						...
						<tr class="tr1">	
								<td align="center">${aduitMedical.doctorTime }</td>
								<td align="center">${aduitMedical.doctorAdrress }</td>
...
$("a.chakan").on("click",function(){ 
	layer.open({ 
			  type: 2,
			    ...
			    shade: 0.8,
			    area : [ '900px', '600px' ],
			    content : '${ctx}/userinfo/antenatal/antenatalDetails?id='+$(this).attr("id")
