...
<div id="content" class="Mee"> 
		...
		<div class="gywm">
			<div class="center">
			 <form id="searchForm" action="${ctx}/userinfo/chronicillness/HypertensionAskInfo" name="searchForm" class="form-inline">
					...
					<div class="Gnavbar" style="">
						<ul style="">
							<li><a href="${ctx}/userinfo/chronicillness/SugarDiabetesAskInfo"
								class="opacity">糖尿病</a></li>
							<li><a href="${ctx}/userinfo/chronicillness/HypertensionAskInfo" class="opacity  on">高血压</a>
							</li>
						</ul>
				...
				<div class="r">
					...
					<div class="Gselect on">
						<table cellspacing="0" cellpadding="0">
							...
							<c:forEach items="${page.list}" var="hypertension" varStatus="i">
								<tr class="tr1">
									<td align="center">${i.index+1}</td>
									<td align="center">${hypertension.time}</td>
									<td align="center">${hypertension.followOrgName }</td>
									<td align="center">高血压</td>
									<td align="center"><a href="" id="${hypertension.id}"
...
$("a.chakan").on("click",function(){ 
	layer.open({ 
			  type: 2,
			    ...
			    shade: 0.8,
			    area : [ '900px', '600px' ],
			    content : '${ctx}/userinfo/chronicillness/HypertensionAskDetailInfo?idrecord='+$(this).attr("id")
	})
})
