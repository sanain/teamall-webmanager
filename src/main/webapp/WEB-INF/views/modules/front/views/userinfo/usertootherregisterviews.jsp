...
<div id="content" class="Mee"> 
		...
		<div class="bar">
			  <ul>
				<li><a href="${ctx}/userinfo/userregisterinfo?id=0" class="opacity">我的预约</a>
				</li>
				<li><a href="${ctx}/userinfo/userregisterinfo?id=1" class="opacity on">我为他人预约</a>
				</li>
			...
			<div class="center">
				<table cellspacing="0" ceelpadding='0'>
					...
					<c:forEach var="rgistermsg" items="${page.list}" varStatus="varStatus">
					 <c:set var="hosp" value="${fnf:getHospitalByintId(rgistermsg.hospitalId)}"/> 
					<tr>
