			...
			<div class="center">
				<div class="l">
					<div class="Gnavbar" style="">
						<ul style="">
						<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalBaseInfo?idnote=${zhengzhuanglnfo.idNote}&idextension=${zhengzhuanglnfo.idExtension}" class="opacity ">住院信息</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalSymptomInfo?idnote=${zhengzhuanglnfo.idNote}&idextension=${zhengzhuanglnfo.idExtension}" class="opacity on  ">症状</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalReportInfo?idnote=${zhengzhuanglnfo.idNote}&idextension=${zhengzhuanglnfo.idExtension}" class="opacity">检查检验报告</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalDiagnoseInfo?idnote=${zhengzhuanglnfo.idNote}&idextension=${zhengzhuanglnfo.idExtension}" class="opacity">诊断记录</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalHelpPlanInfo?idnote=${zhengzhuanglnfo.idNote}&idextension=${zhengzhuanglnfo.idExtension}" class="opacity">治疗计划</a>
							</li>
							<li><a href="${ctx}/userinfo/inhospitaldruginfo/InHospitalDrugInfo?idnote=${zhengzhuanglnfo.idNote}&idextension=${zhengzhuanglnfo.idExtension}" class="opacity">用药</a>
							</li>
						</ul>
					...
					<div class="Gselect on">
						<table cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="75%" class="indent">${zhengzhuanglnfo.startDatr}</td>
							</tr>
							<tr>
								<td width="25%" align="center">症状持续时间</td>
								<td width="75%" class="indent">${zhengzhuanglnfo.duration}</td>
							</tr>
							<tr>
								<td width="25%" align="center">症状名称</td>
								<td width="75%" class="indent">${zhengzhuanglnfo.zzName}</td>
							</tr>
							<tr>
								<td width="25%" align="center">症状详细描述</td>
								<td width="75%" class="indent">${zhengzhuanglnfo.valueName}</td>
							</tr>
