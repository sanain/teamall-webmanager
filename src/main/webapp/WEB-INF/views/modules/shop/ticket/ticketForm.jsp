...
<head>
    ...
    <script type="text/javascript">
        ...
        function submit() {
            ...
            $.ajax({
                type : "POST",
                url : ctxweb+"/shop/ticket/insertTicket", //请求的url地址
                data:{modelName:modelName,size:size,templateText:templateText},
                success : function(data) {
                    if(data.code=='00'){
                        hide();
                        alert("添加成功！");
                        window.location.href="${ctxweb}/shop/ticket/ticketList";
                    }
                }
            });
        }
...
<script>
    ...
    $.ajax({
        type : "POST",
        url : ctxweb+"/shop/ticket/getEbDictionaries", //请求的url地址
        success : function(data) {
            var str="";
    ...
    function replace(){
        ...
        $.ajax({
            type : "POST",
            url : ctxweb+"/shop/ticket/replace", //请求的url地址
