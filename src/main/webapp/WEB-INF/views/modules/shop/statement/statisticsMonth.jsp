	...
	<div class="overp">
		...
		<div class="backcolor commontitle">
			<ul class="clearfix overp">
				<li class="select1"><a
					href="${ctxweb}/shop/statement/statisticsList?type=2&isAll=0"><b></b>营收明细</a></li>
	...
	<script type="text/javascript">
		$(function() {
			laydate.render({
				...
				range : true,
					...
					getstatisticsList(value, type, "2");
				}
			});
			$(".section1 .li").click(function() {
				...
				getstatisticsList(customTime, type, "2");
			})
			var customTime = $.trim($("#customTime").val());
			getstatisticsList(customTime, "2", "2");
		})
		...
		function getorderInfoByDayList(orderInfoByDayList) {
			...
			for (var i = 0; i < orderInfoByDayList.length; i++) {
				...
				data2.push(orderInfoByDayList[i].realMoney);
				data3.push(orderInfoByDayList[i].orderCount);
				data4.push(orderInfoByDayList[i].payableMoney);
			}
