...
<body>
	...
	<form:form id="searchForm" modelAttribute="pmShopUser" action="${ctxsys}/statement/handoverList" method="post" class="breadcrumb form-search ">
		...
		<ul class="ul-form">
		  <li><label>员工名字:</label> <input type="text" style=" width: 100px;" name="username"   value="${pmShopUser.username}" placeholder="请输入员工的名字"/></li>
		  <li><label>员工编号:</label><input  type="text" name="jobNumber"   style=" width: 100px;" value="${pmShopUser.jobNumber}" placeholder="请输入员工的工号"/></li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed" >
		<tr class="title-tr">
              ...
              <th><span>收银员编号</span></th>
               <th class="sore-th" onclick="sortTable(4)"><span>销售总额</span><span class="flag-span">↕</span></th>
              <th class="sore-th" onclick="sortTable(5)"><span>现金支付</span><span class="flag-span">↕</span></th>
              <th class="sore-th" onclick="sortTable(6)"><span>微信支付</span><span class="flag-span">↕</span></th>
              <th class="sore-th" onclick="sortTable(7)"><span>支付宝</span><span class="flag-span">↕</span></th>
              <th class="sore-th" onclick="sortTable(8)"><span>余额</span><span class="flag-span">↕</span></th>
