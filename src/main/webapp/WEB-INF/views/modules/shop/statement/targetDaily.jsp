	...
	<div class="overp">
		...
		<div class="backcolor commontitle">
			<ul class="clearfix overp">
				<li class="select1"><a href="${ctxweb}/shop/statement/indicatorList?type=1&isAll=0"><b></b>营收明细</a></li>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('.selectpicker').on("change", function() {
				...
				getstatisticsList(value, customTime, type, "1");
			})
			...
			laydate.render({
				...
				range : true,
				 ...
				 var type = $(this).attr("type");
					getstatisticsList(selectValue, value, type,"1");
				}
			});
