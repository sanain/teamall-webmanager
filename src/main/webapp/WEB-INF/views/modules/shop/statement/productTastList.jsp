...
<head>
    ...
    <style type="text/css">
        * {
        ...
        .info-div>ul>li, #noChargingData li ,#chargingData li{
            list-style: none;
            font-size: 12px;
            line-height: 38px;
            float: left;
...
.info-div{background:#fff;padding-bottom:20px;}
...
<div class="content">
    <div style="background:#fff;">
        <div class="layui-inline" id="searchForm-div">
            <form:form id="searchForm" modelAttribute="pmBusinessStatistics" action="${ctxweb}/shop/statement/produtTasteList" method="post" class="breadcrumb form-search ">
                <ul class="ul-form">
                    <input type="hidden" value="${shopId}" name="shopId" class="shopId" id="chooseShopId">
                    ...
                    <%--<li>--%>
                        <%--<label>显示方式：</label>--%>
                        <%--<input type="radio" name="isAll" onclick="chooseShop(1)" value="1" style="margin-bottom: 3px" <c:if test="${isAll == 1}">checked="checked"</c:if>>汇总--%>
                        ...
                        <%--</select>--%>
                    <%--</li>--%>
                    <li> &nbsp;&nbsp;<input style="background: #393D49" id="btnSubmit" class="btn btn-primary" type="submit" value="查询" onclick="return page();"/></li>
                    <li><input style="background: #393D49" class="btn btn-primary check-a1" type="reset" value="重置"/></li>
                </ul>
            </form:form>
        </div>
    </div>
    <div class="orderdetail">
        <div class="info-div">
                ...
                <div class="info-div">
                    ...
                    <c:if test="${tasteList != null && tasteList.size() > 0}">
                        <c:forEach items="${tasteList}" var="taste">
                            <ul class="highLight">
                                <li>${taste.isAll == 1 ? "汇总":taste.shopName}</li>
                                <li>${taste.weightStoreSales}  /  ${taste.weightStoreSalesProportion}</li>
                                <li>${taste.weightSelfSales}  /  ${taste.weightSelfSalesProportion}</li>
                                <li>${taste.weightOnlineSales}  /  ${taste.weightOnlineSalesProportion}</li>
                                <li>${taste.weightSalesCount}</li>
                                <li><fmt:formatDate value='${taste.totalTime}' pattern='yyyy-MM-dd'/></li>
                            </ul>
                        </c:forEach>
                    </c:if>
            ...
            <div class="info-div" style="text-align: center">
                ...
                <c:if test="${rankingPage1.list != null && rankingPage1.list.size() != 0}">
                    <form id="noChargingForm" action="${ctxweb}/shop/statement/productTasteCharging" method="post" class="breadcrumb form-search ">
            ...
            <div class="info-div" style="text-align: center">
                ...
                <c:if test="${rankingPage2.list != null && rankingPage2.list.size() != 0}">
                    <form id="chargingForm" action="${ctxweb}/shop/statement/productTasteCharging" method="post" class="breadcrumb form-search ">
            ...
            <c:if test="${fns:isShowWeight()}">
                <div class="info-div" style="text-align: center">
                    ...
                    <c:if test="${rankingPage3.list != null && rankingPage3.list.size() != 0}">
                        <form id="weightForm" action="${ctxweb}/shop/statement/productTasteCharging" method="post" class="breadcrumb form-search ">
