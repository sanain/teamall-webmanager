...
<body style="height: 100%">
	 ...
	 <li ><a href="${ctxweb}/shop/PmProductTypeSpertAttrValue/list?spertAttrId=${spertAttrId}">规格属性明细列表</a></li>
	 <li class="active"><a href="${ctxweb}/shop/PmProductTypeSpertAttrValue/from?spertAttrId=${spertAttrId}">规格属性${not empty sbProductTypeSpertAttrValue.id?'修改':'添加'}
	</a></li>
	</ul><br/> 
	
	<form:form id="inputForm" modelAttribute="sbProductTypeSpertAttrValue" action="${ctxweb}/shop/PmProductTypeSpertAttrValue/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
