...
<head>
    ...
    <script type="text/javascript">
		...
		if(n) $("#pageNo").val(n);
	    if(s) $("#pageSize").val(s);
	          $("#searchForm").attr("action","${ctxweb}/shop/product/shopchooseProducts");
	          $("#searchForm").submit();
	    	return false;
	    }
...
<body>
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="merchandise:pro:view"><li class="active"><a href="${ctxweb}/shop/product/shopchooseProducts">商品列表</a></li></shiro:hasPermission>
	</ul>
	 <form:form id="searchForm" modelAttribute="ebProduct" action="${ctxweb}/shop/product/shopchooseProducts" method="post" class="breadcrumb form-search ">
		...
		<ul class="ul-form">
		     ...
		     <li><label>商品名字:</label><form:input path="productName" htmlEscape="false" maxlength="50" class="input-medium"  placeholder="请输入商品名字"/><input style="margin-left:10px;background: #4778C7;" id="btnSubmit" class="btn btn-primary " type="submit" value="查询" onclick="return page();"/></li>
			 <c:if test="${stule!='99'}">
	...
	<table  class="table table-striped table-condensed table-bordered" >
		...
		<c:forEach items="${page.list}" var="productlist" varStatus="status">
			<tr>
			   <td class="center123"><input type="checkbox" name="ktvs" class="kty chooseItem"  value="${productlist.productId}"></td>
			  <td class="center123">${productlist.productId}</td>
				<td class="center123">
				...
				<td class="center123">${productlist.newShopName}</td>
