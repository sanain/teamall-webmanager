...
<head>
    ...
    <meta name="Description" content="${fns:getProjectName()},添加模块"/>
	<meta name="Keywords" content="${fns:getProjectName()},添加模块"/>
    <title>添加模块</title>
    <link rel="stylesheet" href="${ctxStatic}/sbShop/css/fitment-add.css">
        ...
        <div class="main-box">
          <div class="add-fit" id="main">
            <c:forEach items="${layouttypes}" var="layouttype">
                <a href="${ctxweb}/shop/ShopAdvertise/edit?layouttypeId=${layouttype.id}" class="add-list img">
