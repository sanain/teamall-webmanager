    ...
    function initGeocoder(){
        geocoder = new qq.maps.Geocoder({
            complete : function(result){
                ...
                var ac= result.detail.addressComponents;
                var a = ac.province+","+ac.city+","+ac.district+","+
                    ac.street+","+ac.streetnumber;
...
<body>
            ...
            <div>
				 <li style="display:flex;content-justify:flex-start;aglin-items:baseline;flex-wrap: wrap">
						...
						<font color="red"> *请填写门店名称</font></p>
						   <p style="margin-top:10px;margin-left:10px"><label style="width:120px;float:left;line-height:30px;">所属仓库：</label>
						 <tags:treeselect id="warehouseId" name="warehouseId" value="${ebStore.warehouseId}" labelName="" labelValue="${ebStore.ebWarehouse.wareName}"
					title="选择仓库" url="${ctxsys}/psstore/treeData" extId="" cssClass="required"/></p>
						...
						<p style="margin-top:10px;margin-left:10px"><label style="width:120px">联系人手机号：</label>
						<input type="text" style="width:460px;margin-right: 10px; border-width: 1px;border-style: solid;border-color: rgb(220, 220, 220);border-image: initial;
						border-radius: 3px;padding: 0px 10px;" id="storePeaplePhone" name="storePeaplePhone" value="${ebStore.storePeaplePhone}"/>
						</p>
						<p style="margin-top:10px;margin-left:10px"><font color="red"> *请填写门店联系人手机号，短信提醒。多人提醒请以英文逗号隔开（例如：158172***22,159321***44）</font></p>
    ...
    <script type="text/javascript">
       function bent(){
		 ...
		 var storePeaplePhone=$('#storePeaplePhone').val();
	     ...
	     $.ajax({
			    ...
			    data:{
					...
					storePeaplePhone:storePeaplePhone,
					account:account,
					password:password,
