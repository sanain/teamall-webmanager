...
<head>
 ...
 /*    	function Loginsubmit(){
   	     ...
   	     $.ajax({
			    url : "${ctxweb}/storeItem/loginstore",   
			    type : 'post',
			    data:{
			    	account:account,
			    	password:password,
       ...
       <script type="text/javascript">   
			if(self.frameElement && self.frameElement.tagName == "IFRAME" || $('#left').length > 0 || $('.jbox').length > 0){
				top.location = "${ctxweb}/storeItem/storeLogin";
			}
	</script> 
</head>
<body>
    <div class="logo-div">
     ...
     <form id="loginForm" class="form-signin" action="${ctxweb}/storeItem/storeLogin" method="POST">  
