...
<body>
    ...
    <div class="order">
        ...
        <div class="order-state">
          ...
          <p>指定上门取件人</p>
       <form class="form-horizontal" role="form" method="post" action="${ctxweb}/storeItem/sendReturnStorePeople">
   ...
   <script type="text/javascript">
    ...
    function takegoods(){//确认取件人已经取件
    	     ...
    	     $.ajax({
 			    url : "${ctxweb}/storeItem/saletakegoods",   
 			    type : 'post',
 			    data:{
 			    	saleId:saleId
 					},
 			     ...
 			     if(data.code=='00'){
 			        window.location.href="${ctxweb}/storeItem/saleorderform?saleId="+data.saleId;
 			      }else{
    ...
    <script type="text/javascript">
    function goback(){
    	location.href="${ctxweb}/storeItem/saleorderlist";
    }
     function sendbtn(){
