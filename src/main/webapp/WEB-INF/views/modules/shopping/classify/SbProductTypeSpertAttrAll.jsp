		...
		.col-md-4{
			...
			border:1px solid #ddd;
               ...
               <body scroll="no" >
  					...
  					<iframe id="left" name="left" src="${ctxsys}/PmProductTypeSpertAttr/tree" style="width: 100%; height: 100%;border: 1px solid #69AC72;"></iframe>
  					    <!-- <div id="menuTree" class="ztree" style="margin-top:3px;float:left;"></div> -->
  					</div>
  					<div id="openClose" class="close">&nbsp;</div>
					<div class="col-md-4 up1">
					  <iframe name="right" src="${ctxsys}/PmProductTypeSpertAttr/list?productTypeId=1" style="width: 100%; height: 100%;border: 1px solid #69AC72;" ></iframe>
					</div>
              </body>
        </html>