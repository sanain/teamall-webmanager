...
<div class="navbar-right">
    <div class="navleft">
        <ul>
            ...
            <li class="clearfix">
                <span class="left province-span">满减金额:</span>
            ...
            <li class="clearfix" id="manage-shop-li">
                ...
                <div style="width: 336px" class="right">
                    <input class="right"  type="text" style="width: 80%;float: left" id="shop-names" readonly onclick="openShopList()"/>
        ...
        <div class="clearfix save-box">
            <button class="save" onclick="addPromotion()" style=";background: #69AC72;">提交申请</button>
...
<script type="text/javascript">
    ...
    function openShopList(){
        ...
        if($("#shop-names").val() != ""){
            ...
            var names = $("#shop-names").val().split(",");
            $("#choose-product-name-div").empty();
