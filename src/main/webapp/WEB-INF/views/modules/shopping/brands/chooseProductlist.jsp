...
<head>
    ...
    <script type="text/javascript">
		...
		if(n) $("#pageNo").val(n);
	    if(s) $("#pageSize").val(s);
	          $("#searchForm").attr("action","${ctxsys}/Product/chooseProducts");
	          $("#searchForm").submit();
	    	return false;
	    }
	    function eblabelLs(){
...
<body>
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="merchandise:pro:view"><li class="active"><a href="${ctxsys}/Product/chooseProducts">商品列表</a></li></shiro:hasPermission>
	</ul>
	 <form:form id="searchForm" modelAttribute="ebProduct" action="${ctxsys}/Product/list" method="post" class="breadcrumb form-search ">
		...
		<ul class="ul-form">
		     ...
		     <li><label>商品名字:</label><form:input path="productName" htmlEscape="false" maxlength="50" class="input-medium"  placeholder="请输入商品名字"/><input style="margin-left:10px" id="btnSubmit" class="btn btn-primary " type="submit" value="查询" onclick="return page();"/></li>
			 <c:if test="${stule!='99'}">
