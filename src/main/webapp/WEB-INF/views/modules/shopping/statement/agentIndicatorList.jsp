...
<script type="text/javascript">
	...
	function page(n,s){
		if(n) $("#pageNo").val(n);
		if(s) $("#pageSize").val(s);
		$("#searchForm").attr("action","${ctxsys}/agentStatement/indicatorList");
		$("#searchForm").submit();
		return false;
	}
</script>
...
<body>
	...
	<form:form id="searchForm" modelAttribute="pmBusinessStatistics" action="${ctxsys}/agentStatement/indicatorList" method="post" class="breadcrumb form-search ">
            ...
            <div class="check1">
                <div class="check-box">
                    ...
                    <ul class="mn1">
                        ...
                        <li class="checkbox"><input type="checkbox" class="kl" name="syllable" value="代理商名称,agentName"><label><i></i>代理商</label></li>
                        <li class="checkbox"><input type="checkbox" class="kl" name="syllable" value="名称,shopName"><label><i></i>名称</label></li>
                        <li class="checkbox"><input type="checkbox" class="kl" name="syllable" value="实收金额,realAmount"><label><i></i>销售总金额(合计)</label></li>
                        <li class="checkbox"><input type="checkbox" class="kl" name="syllable" value="订单总数,orderCount"><label><i></i>实收金额(合计)</label></li>
                        <li class="checkbox"><input type="checkbox" class="kl" name="syllable" value="单均消费,averaging"><label><i></i>订单总数(合计)</label></li>
                        <li class="checkbox"><input type="checkbox" class="kl" name="syllable" value="员工人数,employees"><label><i></i>销售总金额(门店)</label></li>
    ...
    <script type="text/javascript">
        ...
        $('#fromNewActionSbM').click(function(){
            $.ajax({
                ...
                url : "${ctxsys}/agentStatement/indicatorExcel",
