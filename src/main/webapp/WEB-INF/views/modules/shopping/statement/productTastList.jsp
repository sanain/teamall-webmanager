...
<div class="content">
    <div class="">
        <div class="layui-inline">
            <form:form id="searchForm" modelAttribute="pmBusinessStatistics" action="${ctxsys}/statement/produtTasteList" method="post" class="breadcrumb form-search ">
                <ul class="ul-form">
    ...
    <div class="orderdetail">
        <div class="info-div">
            ...
            <div class="info-div" style="text-align: center">
                ...
                <c:if test="${rankingPage1.list != null && rankingPage1.list.size() != 0}">
                    <form id="noChargingForm" action="${ctxsys}/statement/productTasteCharging" method="post" class="breadcrumb form-search ">
            ...
            <div class="info-div" style="text-align: center">
                ...
                <c:if test="${rankingPage2.list != null && rankingPage2.list.size() != 0}">
                    <form id="chargingForm" action="${ctxsys}/statement/productTasteCharging" method="post" class="breadcrumb form-search ">
            ...
            <c:if test="${fns:isShowWeight()}">
                <div class="info-div" style="text-align: center">
                    ...
                    <c:if test="${rankingPage3.list != null && rankingPage3.list.size() != 0}">
                        <form id="weightForm" action="${ctxsys}/statement/productTasteCharging" method="post" class="breadcrumb form-search ">
