...
<head>
    ...
    <title>营业统计</title>
    <link rel="stylesheet" href="${ctxStatic}/h5/agent/css/business-statistics.css">
    ...
    var f=true;
        ...
        function scrollHtml(lastRow){
        	 $.ajax({
	             type: "POST",
	             async: false,
	             url: "${ctxweb}/h5/agentUser/businessStatisticsList",
	             ...
	             if(data!=null&&data.length>0){ 
	            	 endRow=parseInt(lastRow)+10;
	                  for (var i=0;i<data.length;i++){
	                     ...
	                     html+="<ul><li><a href='${ctxweb}/h5/agentUser/transactionDetails?time="+data[i].information+"'>"+data[i].information+"</a></li><li>"+data[i].totalVolume+"</li><li>"+data[i].totalRevenue+"</li></ul>";
	                   }
	                  if(data.length<10){ 
	                	  f=false;
    ...
    <div class="context">
        ...
        <div class="detailed">
            ...
            <div class="detailed-list" id="detailed"><%--
                <ul>
                    <li><a href="transaction-details.html">2017-6-29</a></li>
                    <li>167.22</li>
                    <li>5615.02</li>
                </ul>
            --%></div>
