        ...
        $(function(){
            ...
            function scrollHtml(lastRow){
        	 $.ajax({
	             type: "POST",
	             async: false,
	             url: "${ctxweb}/h5/agentUser/agentChangeLoveList",
	             ...
	             if(data!=null&&data.length>0){ 
	            	 endRow=parseInt(lastRow)+10;
	                  for (var i=0;i<data.length;i++){
	                	  nums.push(data[i].amt);
	                     html+="<li><span>"+timeStamp2String(data[i].createTime)+"</span><div><p style='width: 100%'><b>"+data[i].amt+"</b></p></div></li>";
	                   }
	               }else{
	              }
        ...
        <div class="detailed">
            <ul id="detailed">
                <%--<li>
                    ...
                    <div>
                        <p style="width: ${pc.amt/maxAmt*100<20?20:pc.amt/maxAmt*100}%">
                            <b>${pc.amt}</b>
                        </p>
                    </div>
                </li>
