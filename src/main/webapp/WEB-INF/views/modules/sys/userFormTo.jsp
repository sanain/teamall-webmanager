...
<div class="ibox-content">
	<ul class="nav nav-tabs">
		<li><a href="${ctxsys}/sys/user/daililist?office.isAgent=1&company.isAgent=1">用户列表</a></li>
		<li class="active"><a href="${ctxsys}/sys/user/form1?id=${user.id}">用户<shiro:hasPermission name="sys:user:edit">${not empty user.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:user:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctxsys}/sys/user/save1" method="post" class="form-horizontal">
		<form:hidden path="id"/>
