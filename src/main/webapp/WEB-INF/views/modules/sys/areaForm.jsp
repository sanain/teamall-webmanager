...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxsys}/sys/area/">区域列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="area" action="${ctxsys}/sys/area/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<tags:treeselect id="area" name="parent.id" value="${area.parent.id}" labelName="parent.name" labelValue="${area.parent.name}"
					title="区域" url="${ctxsys}/sys/area/treeData" extId="${area.id}" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="type">区域类型:</label>
			<div class="controls">
