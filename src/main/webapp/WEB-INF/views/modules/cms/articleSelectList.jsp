...
<body>
	...
	<form:form id="searchForm" modelAttribute="article" action="${ctxsys}/cms/article/selectList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="article">
			<tr>
				...
				<td><a href="${ctxsys}/cms/article/form?id=${article.id}" title="${article.title}" onclick="return view(this.href);">${fns:abbr(article.title,40)}</a></td>
