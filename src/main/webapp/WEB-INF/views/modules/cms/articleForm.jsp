...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxsys}/cms/article/?category.id=${article.category.id}">文章列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctxsys}/cms/article/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<script type="text/javascript">
					...
					$.getJSON("${ctxsys}/cms/article/findByIds",{ids:$("#articleDataRelation").val()},function(data){
					...
					$("#relationButton").click(function(){
						top.$.jBox.open("iframe:${ctxsys}/cms/article/selectList?pageSize=8", "添加相关",$(top.document).width()-220,$(top.document).height()-180,{
		...
		<c:if test="${not empty article.id}">
			<div class="control-group">
				...
				<div class="controls">
					<input id="btnComment" class="btn" type="button" value="查看评论" onclick="viewComment('${ctxsys}/cms/comment/?module=article&contentId=${article.id}&status=0')"/>
					<script type="text/javascript">
