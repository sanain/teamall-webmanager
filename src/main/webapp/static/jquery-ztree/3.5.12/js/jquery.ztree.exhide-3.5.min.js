...
(function(i) {
        ...
        view: {
            ...
            showNodes: function(c, a, b) {
                if (a && a.length != 0) {
                    ...
                    for (var k in d) a = d[k][c.data.key.children],
            ...
            setFirstNodeForShow: function(c, a) {
                var b, d, h, e, g;
                for (d = 0, h = a.length; d < h; d++) if (b = a[d], !e && !b.isHidden && b.isFirstNode) {
                    e = b;
                    break
    ...
    e.addZTreeTools(function(c, a) {
        ...
        var b = a.checkNode;
        if (b) a.checkNode = function(c, e, f, g) { (!c || !c.isHidden) && b.apply(a, arguments)
        }
    });
    var m = e.initNode;
    e.tmpHideParent = -1;
    ...
    var n = e.makeChkFlag;
    if (n) e.makeChkFlag = function(c, a) { (!a || !a.isHidden) && n.apply(e, arguments)
    };
    ...
    if (q) f.expandCollapseSonNode = function(c, a, b, d, e) { (!a || !a.isHidden) && q.apply(f, arguments)
    };
    var r = f.setSonNodeCheckBox;
    if (r) f.setSonNodeCheckBox = function(c, a, b, d) { (!a || !a.isHidden) && r.apply(f, arguments)
    };
    var s = f.repairParentChkClassWithSelf;
    if (s) f.repairParentChkClassWithSelf = function(c, a) { (!a || !a.isHidden) && s.apply(f, arguments)
    }
})(jQuery);