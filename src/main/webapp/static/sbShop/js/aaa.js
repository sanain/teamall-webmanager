$(function(){
    ...
    $('body').on('click','.add-child',function(){
        var li=`<ul class="ul-list">
            ...
            <li></li>
            <li><a class="sy-ul" href="javascript:;"><img src="sbShop/images/zhankai2.png" alt=""></a></li>
            <li><a class="xy-ul" href="javascript:;"><img src="sbShop/images/zhankai1.png" alt=""></a></li>
            <li><a class="ul-list-del" href="javascript:;"><img src="sbShop/images/xxx-rzt.png" alt=""></a></li>
            </ul>`;
    ...
    $('body').on('click','.add-fu',function(){
        ...
        <div class="new-div">
            <ul class="new-ul">
                ...
                <li><a class="sy-div" href="javascript:;"><img src="sbShop/images/zhankai2.png" alt=""></a></li>
                <li><a class="xy-div" href="javascript:;"><img src="sbShop/images/zhankai1.png" alt=""></a></li>
                <li><a class="new-ul-del" href="javascript:;"><img src="sbShop/images/xxx-rzt.png" alt=""></a></li>
            </ul>
            <ul class="ul-list">
            	<li></li>
                <li><input type="text"></li>
