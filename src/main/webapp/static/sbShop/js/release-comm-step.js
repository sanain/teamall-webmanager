function addboft() {
    ...
    $.ajax({
        type: "POST",
        url: contextPath + "/shop/product/commercialeDetail",
...
$(function () {
    ...
    $('body').on('click', '.step3', function () {
        ...
        if ($('.shop-news ul li:nth-child(3) .radio:nth-child(3) input').is(':checked')) {
...
//                    addtable()
    ...
    function  colspan() {
        ...
        if($('.right-ul1').length>2){
            if($($('.right-ul1')[2]).find('span').length>0){
                colspan=colspan+1;
            }
        }
        if($('.right-ul1').length>3){
    ...
    $('body').on('click', '.right-ul1  li b', function () {
        ...
        $.ajax({
            type: "POST",
            url: contextPath + "/shop/product/deletecommercialeDehors",
    ...
    $('.guige .guige-box-add').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: contextPath + "/shop/product/addcommercialeDehors",
            data: {values: txt, typeId: snv, productId: $("#kk").val()},
            success: function (date) {
                for (var j = 0; j < date.length; j++) {
                    html2 += `<span>${date[j].spertAttrValue}<input type="hidden"  name="attrId" value=${date[j].id}><b></b></span>`;
                }
                html2 += `<a href="javascript:;"><img src="${contextPath}/static/sbShop/images/add-a.png"></a>`;
                        ...
                        if ($($('.right-ul1')[0]).find('span').length == snu) {
                            ...
                            if (snu == 1) {
                                for (s = 0; s < date.length; s++) {
                                    $('.table-div table tbody').append(`<tr><td data-t="${date[s].id}">${date[s].spertAttrValue}<input name="standard_id_str" type="hidden" value="${date[s].id}"></td><td><input class="num t-shi" name="market_price" type="text"></td>
	                              		 <td><input class="num t-ben" name="detail_prices" type="text"></td>
	                              		 <td><input class="num t-ran" name="return_ratio" type="text"></td>
	                                	 <td><input readonly class="num t-jie" name="supply_price" type="text"></td>
	                                	 <td ><input class="num t-huiy" name="member_price" type="text"></td>
...
function addtable() {
    ...
    if (span3.length != 0) {
        if (span2.length == 0 && span1.length != 0) {
            ...
            for (j = 0; j < span2.length; j++) {
                for (n = 0; n < span3.length; n++) {
                    htm += `<tr><td data-t="${$(span2[j]).find('input').val()}">${$(span2[j]).text()}</td><td data-t="${$(span3[n]).find('input').val()}">${$(span3[n]).text()}</td><td style="display: none"><input class="num t-shi" name="market_price"  type="text"></td>
                                <td><input class="num t-ben" name="detail_prices" type="text"></td>
                                <td style="display: none"><input class="num t-ran" name="return_ratio" type="text"></td>
                                <td style="display: none"><input readonly class="num t-jie" name="supply_price" type="text"></td>
                                <td ><input class="num t-huiy" name="member_price" type="text"></td>
            ...
            for (n = 0; n < span3.length; n++) {
                htm += `<tr><td data-t="${$(span3[n]).find('input').val()}">${$(span3[n]).text()}</td><td style="display: none"><input class="num t-shi" name="market_price"  type="text"></td>
                                <td><input class="num t-ben" name="detail_prices" type="text"></td>
                                <td style="display: none"><input class="num t-ran" name="return_ratio" type="text"></td>
                                <td style="display: none"><input readonly class="num t-jie" name="supply_price" type="text"></td>
                                 <td ><input class="num t-huiy" name="member_price" type="text"></td>
        ...
        if (span2.length != 0) {
            ...
            for (i = 0; i < span1.length; i++) {
                htm += `<tr><td data-t="${$(span1[i]).find('input').val()}">${$(span1[i]).text()}<input name="standard_id_str" type="hidden" value="${$(span1[i]).children('input').val()}"><input name="standard_value_str" type="hidden" value="${text1 + ':' + $(span1[i]).text()}"></td><td  style="display: none"><input class="num t-shi" name="market_price" type="text"></td>
		                <td><input class="num t-ben" name="detail_prices" type="text"></td>
		                <td  style="display: none"><input class="num t-ran" name="return_ratio" type="text"></td>
		                <td  style="display: none"><input readonly class="num t-jie" name="supply_price" type="text"></td>
		                  <td ><input class="num t-huiy" name="member_price" type="text"></td>
