package com.jq.support.main.controller.merchandise.ticket;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/ticket/")
public class TicketListController {
    ...
    public String index (HttpServletRequest request, HttpServletResponse response, Model model){
        Page<EbTicket> page=ebTicketService.getPageList(new Page<EbTicket>(request, response));
        model.addAttribute("page", page);
        return "modules/shopping/ticket/ticketList";
    }
    ...
    public String insert (HttpServletRequest request, HttpServletResponse response, Model model){
        ...
        return "modules/shopping/ticket/ticketForm";
    }
    ...
    public Map<String,Object> stateTicket(HttpServletRequest request){
        ...
        try{
            ebTicketService.findEbTicketState(Integer.parseInt(type));
            EbTicket ebTicket=ebTicketService.get(Integer.parseInt(id));
            //切换状态
